...
try:
    # Load dataset dengan encoding UTF-8
...
def index():
    ...
    if request.method == "POST":
        try:
            ...
            return render_template("index.html", error="Terjadi kesalahan dalam memproses permintaan Anda.")
